...
class Policy extends Component {
    ...
    render() {
        ...
        W celu usprawnienia użytkownikom procesu rejestracji oraz zapewnienia maksimum bezpieczeństwa, portal livesearch.pl wykorzystuje mechanizm zewnętrznego uwierzytelnienia. 
        ...
        <br/>
        - unikalny identyfikator Twojego konta Google lub Facebook
        <br/>
        - adres email, imię i nazwisko użytkownika oraz link do zdjęcia profilowego
        <br/>
        Dane te używane są do założenia konta a następnie jego  identyfikacji w bazie danych portalu livesearch.<br/> 
